...
<head>
	<meta charset="UTF-8">
	<title>Laravel PHP Framework :: Running on OpenShift</title>
	<style>
...
<body>
	<div class="welcome">
		<a href="http://laravel.com" title="Laravel PHP Framework">
		  <i class="fa fa-spinner fa-spin fa-5x larvel-pink"></i>
		...
		<h1>...but I'm probably waiting for a deploy, whatever that is.</h1>
	</div>
</body>
</html>
